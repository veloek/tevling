...
namespace Tevling.Migrations
{
    ...
    [Migration("20260305065252_WelcomeMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AthleteChallengeGroup", b =>
                {
                    ...
                    b.HasKey("ChallengeGroupId", "MembersId");
            ...
            modelBuilder.Entity("Tevling.Model.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Tevling.Model.AcceptedFollowRequest", b =>
                {
                    b.HasBaseType("Tevling.Model.Notification");

                    b.HasDiscriminator().HasValue("AcceptedFollowRequest");
                });

            modelBuilder.Entity("Tevling.Model.ChallengeInvite", b =>
                {
                    b.HasBaseType("Tevling.Model.Notification");
                    ...
                    b.HasDiscriminator().HasValue("ChallengeInvite");
                });

            modelBuilder.Entity("Tevling.Model.NewFollowRequest", b =>
                {
                    b.HasBaseType("Tevling.Model.Notification");
            ...
            modelBuilder.Entity("AthleteChallengeGroup", b =>
                {
                    b.HasOne("Tevling.Model.ChallengeGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tevling.Model.Notification", b =>
                {
                    ...
                    b.HasOne("Tevling.Model.Athlete", "Recipient")
                        .WithMany()
            ...
            modelBuilder.Entity("Tevling.Model.Athlete", b =>
                {
                    ...
                    b.Navigation("ChallengeTemplates");
                });
