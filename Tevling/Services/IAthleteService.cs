...
public interface IAthleteService
{
    ...
    Task<Athlete> AcceptFollowerAsync(Athlete athlete, int followerId, CancellationToken ct = default);
    Task<Athlete> DeclineFollowerAsync(Athlete athlete, int followerId, CancellationToken ct = default);
    ...
    IObservable<FeedUpdate<FollowRequest>> GetAthleteFollowersFeed(int athleteId);
